...
def get_use_case(
    ...
    """Factory para o caso de uso GetAllBooks, que depende de um repositório."""
...
def search_books_use_case(
    ...
    """Factory para o caso de uso SearchBooks, que depende de um repositório."""
...
def get_book_by_id_use_case(
    ...
    """Factory para o caso de uso GetBookById, que depende de um repositório."""
...
def get_all_categories_use_case(
    ...
    """Factory para o caso de uso GetAllCategories, que depende de um repositório."""
...
def get_books(use_case: GetAllBooks = Depends(get_use_case)):
    ...
    try:
        ...
        logger.error(f"Erro do repositório ao buscar todos os livros: {e.message}")
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
